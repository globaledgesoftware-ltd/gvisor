...
func send4(r *stack.Route, ident uint16, data buffer.View, ttl uint8) *tcpip.Error {
	...
	return r.WritePacket(nil /* gso */, hdr, data.ToVectorisedView(), header.ICMPv4ProtocolNumber, ttl)
}
...
func send6(r *stack.Route, ident uint16, data buffer.View, ttl uint8) *tcpip.Error {
	...
	return r.WritePacket(nil /* gso */, hdr, data.ToVectorisedView(), header.ICMPv6ProtocolNumber, ttl)
}
